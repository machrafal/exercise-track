...
# =============================================
# Chauvenetes criterion (distribution based)
# =============================================
...
# =============================================
# Loclal Outlier function (distance based)
# =============================================
...
for col in outlier_columns:
    for label in df["label"].unique():
        dataset = mark_outliers_chauvenet(df[df["label"] == label], col)
        # replace values markes as outliers with NaN
...
# Outliers removed using Chauvenetes criterion
